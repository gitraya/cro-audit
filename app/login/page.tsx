      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          ...
          <section className="grid gap-6">
            <form action={signIn} className="border border-neutral-200 bg-white p-6">
              ...
              <button
                type="submit"
                className="mt-6 w-full bg-neutral-950 px-4 py-2.5 text-sm font-medium text-white"
              >
                Sign in
              </button>
            </form>

            <form action={signUp} className="border border-neutral-200 bg-white p-6">
              ...
              <button
                type="submit"
                className="mt-6 w-full border border-neutral-950 px-4 py-2.5 text-sm font-medium"
              >
                Sign up
              </button>
            </form>
